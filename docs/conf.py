...
# -*- coding: utf-8 -*-
#
# MyNewProject documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under mynewproject
modindex_common_prefix = [
    'mynewproject.'
]

# General information about the project.
project = u'My New Project'
...
# The short X.Y version.
# version = mynewproject.__version__
# The full version, including alpha/beta/rc tags.
# release = mynewproject.__version__
...
htmlhelp_basename = 'MyNewProjectdoc'
...
latex_documents = [
    ('index', 'MyNewProject.tex',
     u'My New Project Documentation',
     u'hanyuan', 'manual'),
]
